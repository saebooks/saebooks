...
Per ``[[feedback_saebooks-hard-delete-policy]]`` admins MUST be able
to hard-delete synced rows; the guard's job is to surface a clear
warning, not to refuse outright. ``force_sync_override=True`` proceeds.
"""

...
async def _gl_accounts() -> dict:
    async with AsyncSessionLocal() as session:
        ...
        return {
            ...
            "cogs_account_id": await _by_code("5-0000"),
            "income_account_id": await _by_code("4-0000"),
        }
...
async def test_convert_to_inventory_happy(api_client: AsyncClient, gl: dict) -> None:
    ...
    r = await api_client.post(
        ...
        json=_convert_payload(gl, sku="DEMO-001", vin="1HGCM82633A123456"),

"""Phase 1 tier-4 — add version + tenant_id to recurring_invoices.

Required for /api/v1/recurring_invoices: optimistic locking (If-Match)
needs ``version INT`` and multi-tenant isolation needs ``tenant_id UUID``.

Revision ID: 0050_ri_version_tenant
Revises: 0049_fa_version_tenant
...
revision: str = "0050_ri_version_tenant"
down_revision: str | None = "0049_fa_version_tenant"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_DEFAULT_TENANT = "00000000-0000-0000-0000-000000000001"
_TABLE = "recurring_invoices"

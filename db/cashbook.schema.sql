...
CREATE TABLE accounts (
	...
	statutory_account_code VARCHAR(32), 
	statutory_account_label_local VARCHAR(255), 
	statutory_parent_class VARCHAR(64), 
	net_asset_restriction_tier VARCHAR(32), 
	extra JSON, 
...
CREATE TABLE bills (
	...
	base_tax_total NUMERIC(18, 4) NOT NULL, 
	base_total NUMERIC(18, 4) NOT NULL, 
	base_amount_paid NUMERIC(18, 4) NOT NULL, 
	notes TEXT, 
	posted_at DATETIME, 
	posted_by VARCHAR, 
	version INTEGER NOT NULL, 
...
CREATE TABLE companies (
	...
	statutory_framework_code VARCHAR(32), 
	...
	tax_registered BOOLEAN NOT NULL, 
	...
	ar_control_account_code VARCHAR(64), 
	ap_control_account_code VARCHAR(64), 
	ee_payroll_wages_expense_account_code VARCHAR(64), 
	ee_payroll_social_tax_expense_account_code VARCHAR(64), 
	ee_payroll_unemployment_employer_expense_account_code VARCHAR(64), 
	ee_payroll_income_tax_payable_account_code VARCHAR(64), 
	ee_payroll_unemployment_employee_payable_account_code VARCHAR(64), 
	ee_payroll_pillar_ii_payable_account_code VARCHAR(64), 
	ee_payroll_social_tax_payable_account_code VARCHAR(64), 
	ee_payroll_unemployment_employer_payable_account_code VARCHAR(64), 
	ee_payroll_net_pay_clearing_account_code VARCHAR(64), 
	ee_payroll_fringe_benefit_income_tax_expense_account_code VARCHAR(64), 
	ee_payroll_fringe_benefit_social_tax_expense_account_code VARCHAR(64), 
	ee_payroll_fringe_benefit_income_tax_payable_account_code VARCHAR(64), 
	ee_payroll_fringe_benefit_social_tax_payable_account_code VARCHAR(64), 
...
CREATE TABLE company_jurisdictions (
	id CHAR(32) DEFAULT (gen_random_uuid()) NOT NULL, 
	tenant_id CHAR(32) NOT NULL, 
	company_id CHAR(32) NOT NULL, 
	...
	PRIMARY KEY (id), 
	CONSTRAINT uq_company_jurisdictions_natkey UNIQUE (company_id, jurisdiction_code), 
	FOREIGN KEY(tenant_id) REFERENCES tenants (id) ON DELETE RESTRICT, 
	FOREIGN KEY(company_id) REFERENCES companies (id) ON DELETE CASCADE
);
...
CREATE TABLE contacts (
	...
	version INTEGER NOT NULL, 
	e_invoice_recipient BOOLEAN DEFAULT false NOT NULL, 
	peppol_participant_id VARCHAR(64), 
	PRIMARY KEY (id), 
	FOREIGN KEY(company_id) REFERENCES companies (id) ON DELETE CASCADE, 
	FOREIGN KEY(tenant_id) REFERENCES tenants (id) ON DELETE RESTRICT, 
...
CREATE TABLE dutiable_transaction_events (
	...
	surcharge_duty NUMERIC(14, 2), 
	applied_concession_id CHAR(32), 
	applied_surcharge_rate_id CHAR(32), 
	description TEXT, 
...
CREATE TABLE employees (
	...
	ee_pillar_ii_rate_percent NUMERIC(5, 2), 
	ee_basic_exemption_elected BOOLEAN, 
	ee_pensionable_age BOOLEAN, 
...
CREATE TABLE pay_run_lines (
	...
	payg_breakdown JSON, 
	ee_income_tax NUMERIC(14, 2), 
	ee_unemployment_employee NUMERIC(14, 2), 
	ee_unemployment_employer NUMERIC(14, 2), 
	ee_social_tax NUMERIC(14, 2), 
	ee_pillar_ii NUMERIC(14, 2), 
	ee_fringe_benefits JSON DEFAULT '[]' NOT NULL, 
	ee_fringe_benefit_income_tax NUMERIC(14, 2), 
	ee_fringe_benefit_social_tax NUMERIC(14, 2), 
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, 
	PRIMARY KEY (id), 
...
CREATE TABLE tax_returns (
	...
	filed_at DATETIME, 
	ee_filing_request_id VARCHAR(255), 
	ee_filing_state VARCHAR(16), 
	ee_filing_receipt JSON, 
	PRIMARY KEY (id), 
	FOREIGN KEY(company_id) REFERENCES companies (id) ON DELETE CASCADE, 
	FOREIGN KEY(tenant_id) REFERENCES tenants (id) ON DELETE RESTRICT, 
...
CREATE INDEX ix_company_jurisdictions_company_id ON company_jurisdictions (company_id);

CREATE INDEX ix_company_jurisdictions_tenant_id ON company_jurisdictions (tenant_id);

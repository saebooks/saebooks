...
--------------------
Per ``saebooks-marketing-differentiator``, posted invoices
...
# Status mapping. Xero -> SAE Books. We never demote: Xero AUTHORISED
# -> SAE Books POSTED, but if SAE Books is already POSTED and Xero
# says DRAFT, we leave SAE Books alone.

...
a same-tenant pair for the LOCAL primitive — the REAL personal<->sauer edge is
...
personal-tenant <-> sauer-tenant directors-loan edge) CANNOT use this primitive:
...
async def post_local_pair(
    ...
    *,
    ...
    # different tenant stack / DB — e.g. the real personal<->sauer directors-
